...
## Add a Product
{/* SCREENSHOT: Add a Product · product form, builder panel, or checkout example · desktop */}
...
## Buy Link Formats
{/* SCREENSHOT: Buy Link Formats · product form, builder panel, or checkout example · desktop */}
...
## Parameter Options
{/* SCREENSHOT: Parameter Options · product form, builder panel, or checkout example · desktop */}
...
{/* SCREENSHOT: Product Setup Best Practices · product form, builder panel, or checkout example · desktop */}
...
{/* SCREENSHOT: Troubleshooting Buy Links · product form, builder panel, or checkout example · desktop */}
