...
<CardGroup cols={2}>
  <Card title="Organization Callcenter" icon="building">
  ...
  <Card title="Nuyu" icon="user-headset">
    Sales, failed payments, subscription dunning, cancellations, and winback. Phone number is **not** required for sales.
  </Card>
</CardGroup>

## What Each Provider Supports
{/* SCREENSHOT: What Each Provider Supports · integration settings or log state · desktop */}
...
<Info>
A "Yes" in the matrix only declares **what the provider can technically receive**. Each event still has to be explicitly enabled on your integration — see [Per-Event Configuration](#per-event-configuration) below. By default only **Abandoned carts** is enabled for HelpGrid / Logicall / Tauk. All other events are off until you turn them on.
</Info>
...
## Common Use Cases
{/* SCREENSHOT: Common Use Cases · integration settings or log state · desktop */}
...
{/* SCREENSHOT: Per-Event Configuration · integration settings or log state · desktop */}
...
{/* SCREENSHOT: Delays & Auto-Cancellation · integration settings or log state · desktop */}
...
{/* SCREENSHOT: Decline Code Filtering · integration settings or log state · desktop */}
