...
## Transaction Types
{/* SCREENSHOT: Transaction Types · integration settings or log state · desktop */}
...
## Click ID Tracking
{/* SCREENSHOT: Click ID Tracking · integration settings or log state · desktop */}
...
## Conversion Updates
{/* SCREENSHOT: Conversion Updates · integration settings or log state · desktop */}
...
{/* SCREENSHOT: Payment Gateway & Fulfillment Provider · integration settings or log state · desktop */}
...
{/* SCREENSHOT: Automatic Tracking Pixel Creation · integration settings or log state · desktop */}
...
## What Gets Tracked
{/* SCREENSHOT: What Gets Tracked · integration settings or log state · desktop */}
...
{/* SCREENSHOT: What Information is Tracked · integration settings or log state · desktop */}
