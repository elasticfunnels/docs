...
1. Navigate to **Integrations → Order Sync**
2. Find **Shopify** and click **"New integration"**
...
2. Click **"New integration"** for each store
...
1. Open your Shopify integration in **Integrations → Order Sync**
