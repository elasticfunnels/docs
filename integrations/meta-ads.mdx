...
The Meta Ads integration syncs ad spend into ElasticFunnels and sends conversion events back to Meta. Use it to compare campaign cost with funnel revenue and feed better conversion data to Meta.
...
{/* SCREENSHOT: Understanding Pixel Attribution · integration settings or log state · desktop */}
...
{/* SCREENSHOT: Data Privacy & Security · integration settings or log state · desktop */}
