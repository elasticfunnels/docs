...
{/* SCREENSHOT: Secret Key Encryption · integration settings or log state · desktop */}
...
## Order Tracking
{/* SCREENSHOT: Order Tracking · integration settings or log state · desktop */}
...
{/* SCREENSHOT: Automation Integration · integration settings or log state · desktop */}
...
## Tracking Pixels
{/* SCREENSHOT: Tracking Pixels · integration settings or log state · desktop */}
...
{/* SCREENSHOT: Integration Benefits · integration settings or log state · desktop */}
