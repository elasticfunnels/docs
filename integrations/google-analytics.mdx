...
description: 'Connect Google Analytics 4 (GA4) for traffic, behavior, and attribution data'
---

## Overview
{/* SCREENSHOT: Overview · integration settings or log state · desktop */}

Google Analytics integration sends page and conversion data to Google Analytics 4 (GA4). You can set measurement IDs per page when different funnels or campaigns need different GA4 properties.
...
{/* SCREENSHOT: Custom Event Tracking · integration settings or log state · desktop */}
...
## What You'll Track
{/* SCREENSHOT: What You'll Track · integration settings or log state · desktop */}
...
{/* SCREENSHOT: Integration with Conversion Postbacks · integration settings or log state · desktop */}
...
<Info>
The integration can run alongside Meta Ads, Google Ads, and other ad platforms so each tool receives the conversion data it needs.
</Info>

## Advanced Setup
{/* SCREENSHOT: Advanced Setup · integration settings or log state · desktop */}
...
{/* SCREENSHOT: Tips for Better Analytics · integration settings or log state · desktop */}
