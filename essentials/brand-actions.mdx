...
{/* SCREENSHOT: How Brand Actions Work · relevant screen or example output · desktop */}
...
{/* SCREENSHOT: Types of Brand Actions · relevant screen or example output · desktop */}
...
{/* SCREENSHOT: User Experience & Safety Features · relevant screen or example output · desktop */}
...
{/* SCREENSHOT: Action Categories in Detail · relevant screen or example output · desktop */}
...
## Best Practices
{/* SCREENSHOT: Best Practices · relevant screen or example output · desktop */}
...
{/* SCREENSHOT: Troubleshooting Common Issues · relevant screen or example output · desktop */}
...
## Getting Help
{/* SCREENSHOT: Getting Help · relevant screen or example output · desktop */}
