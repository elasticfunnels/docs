...
{/* SCREENSHOT: Before you troubleshoot · relevant screen or example output · desktop */}
...
## Common symptoms
{/* SCREENSHOT: Common symptoms · relevant screen or example output · desktop */}
...
## Example role setups
{/* SCREENSHOT: Example role setups · relevant screen or example output · desktop */}
...
## Admin checklist
{/* SCREENSHOT: Admin checklist · relevant screen or example output · desktop */}
...
{/* SCREENSHOT: Need the full mapping? · relevant screen or example output · desktop */}
