...
## Overview
{/* SCREENSHOT: Overview · relevant screen or example output · desktop */}
...
{/* SCREENSHOT: How access is decided · relevant screen or example output · desktop */}
...
{/* SCREENSHOT: What permissions affect · relevant screen or example output · desktop */}
...
{/* SCREENSHOT: Metrics vs permissions · relevant screen or example output · desktop */}
...
## Common examples
{/* SCREENSHOT: Common examples · relevant screen or example output · desktop */}
...
{/* SCREENSHOT: How to set up a restricted role · relevant screen or example output · desktop */}
...
## Tips for admins
{/* SCREENSHOT: Tips for admins · relevant screen or example output · desktop */}
...
## Next steps
{/* SCREENSHOT: Next steps · relevant screen or example output · desktop */}
