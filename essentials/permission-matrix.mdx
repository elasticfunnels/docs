...
{/* SCREENSHOT: How to use this page · relevant screen or example output · desktop */}
...
## Core rules
{/* SCREENSHOT: Core rules · relevant screen or example output · desktop */}
...
{/* SCREENSHOT: Common capability matrix · relevant screen or example output · desktop */}
...
{/* SCREENSHOT: Metrics access matrix · relevant screen or example output · desktop */}
...
{/* SCREENSHOT: Recommended restricted-role patterns · relevant screen or example output · desktop */}
...
{/* SCREENSHOT: Important differences to remember · relevant screen or example output · desktop */}
...
## Next step
{/* SCREENSHOT: Next step · relevant screen or example output · desktop */}
