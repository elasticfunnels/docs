...
{/* SCREENSHOT: How entries attach to records · CRM workspace or workflow screen · desktop */}
...
## Concepts
{/* SCREENSHOT: Concepts · CRM workspace or workflow screen · desktop */}
...
## Customer CRM Data
{/* SCREENSHOT: Customer CRM Data · CRM workspace or workflow screen · desktop */}
...
## Functions
{/* SCREENSHOT: Functions · CRM workspace or workflow screen · desktop */}
...
| `SetCrmRelation({ slug, relationKey, targetEntryId, ... })` | **Template engine only.** Add a relation from entry to another entry |
| `RemoveCrmRelation({ slug, relationKey, targetEntryId, ... })` | **Template engine only.** Remove a specific relation |
| `reassignCrmReference({ slug, fromReferenceType, fromReferenceId, ... })` | **Backend scripts only.** Move entries from one visitor reference to another (e.g. anonymous → customer after login) |
