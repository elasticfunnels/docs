...
## The pattern
{/* SCREENSHOT: The pattern · CRM workspace or workflow screen · desktop */}
...
{/* SCREENSHOT: Full example: Weight check-in · CRM workspace or workflow screen · desktop */}
...
{/* SCREENSHOT: How it fits together · CRM workspace or workflow screen · desktop */}
...
{/* SCREENSHOT: CRM functions reference · CRM workspace or workflow screen · desktop */}
...
{/* SCREENSHOT: Quiz / anonymous visitor → customer CRM migration · CRM workspace or workflow screen · desktop */}
...
## Security checklist
{/* SCREENSHOT: Security checklist · CRM workspace or workflow screen · desktop */}
...
## POST body limits
{/* SCREENSHOT: POST body limits · CRM workspace or workflow screen · desktop */}
...
## Related
{/* SCREENSHOT: Related · CRM workspace or workflow screen · desktop */}
