...
## Renewal Success
{/* SCREENSHOT: Renewal Success · email editor or template settings · desktop */}
...
## Renewal Failed
{/* SCREENSHOT: Renewal Failed · email editor or template settings · desktop */}
...
{/* SCREENSHOT: Pre-Renewal Reminder · email editor or template settings · desktop */}
...
## Subscription Paused
{/* SCREENSHOT: Subscription Paused · email editor or template settings · desktop */}
...
{/* SCREENSHOT: Subscription Canceled · email editor or template settings · desktop */}
...
{/* SCREENSHOT: Payment Method Expiring · email editor or template settings · desktop */}
...
{/* SCREENSHOT: Configuring subscription emails · email editor or template settings · desktop */}
...
A merchant with an empty slot and no brand default still sends, using the system template.
Subscription slots only appear for merchants that bill recurring charges through
ElasticFunnels (NMI and Stripe).

Nothing sends until the brand has a sender configured. See [Sending Setup](/emails/sending-setup).

See also: [Emails & Dunning settings](/subscriptions/emails-and-dunning) and
[Emails Not Sending](/emails/troubleshooting)
