...
{/* SCREENSHOT: Create a Collection Form · form builder or submission list · desktop */}
...
{/* SCREENSHOT: Add Form to Your Page · form builder or submission list · desktop */}
...
## Form Field Types
{/* SCREENSHOT: Form Field Types · form builder or submission list · desktop */}
...
## Advanced Features
{/* SCREENSHOT: Advanced Features · form builder or submission list · desktop */}
...
## Optimization Tips
{/* SCREENSHOT: Optimization Tips · form builder or submission list · desktop */}
