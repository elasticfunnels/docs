...
{/* SCREENSHOT: How it differs from the legacy macro postback · relevant screen or example output · desktop */}
...
## Configuration
{/* SCREENSHOT: Configuration · relevant screen or example output · desktop */}
...
## Supported events
{/* SCREENSHOT: Supported events · relevant screen or example output · desktop */}
...
## Request format
{/* SCREENSHOT: Request format · relevant screen or example output · desktop */}
...
## Response handling
{/* SCREENSHOT: Response handling · relevant screen or example output · desktop */}
...
## Payload schema
{/* SCREENSHOT: Payload schema · relevant screen or example output · desktop */}
...
## Operational details
{/* SCREENSHOT: Operational details · relevant screen or example output · desktop */}
...
## Testing locally
{/* SCREENSHOT: Testing locally · relevant screen or example output · desktop */}
