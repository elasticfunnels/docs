...
## Two Approaches
{/* SCREENSHOT: Two Approaches · members area screen · desktop */}
...
## Using the `<order>` Tag
{/* SCREENSHOT: Using the `<order>` Tag · members area screen · desktop */}
...
{/* SCREENSHOT: Using `getOrders()` in Backend Scripts · members area screen · desktop */}
...
{/* SCREENSHOT: Using `getOrder()` for a Single Order Detail Page · members area screen · desktop */}
...
{/* SCREENSHOT: Fulfillment status and shipments · members area screen · desktop */}
...
{/* SCREENSHOT: Displaying Tracking Information · members area screen · desktop */}
...
{/* SCREENSHOT: `getSessionOrders()` — Current Session Orders · members area screen · desktop */}
...
The order list is served from the **session itself** — every charge (the main order, order bumps, and each one-click upsell/downsell) is recorded the instant it is processed. That means `getSessionOrders()` returns the **complete** set of orders on the very first page load, including upsells accepted seconds earlier. No indexing wait and no page refresh are required.
...
## Thank You Pages
{/* SCREENSHOT: Thank You Pages · members area screen · desktop */}
...
@else
  <div class="processing">
    <p>We're finalizing your order. Check your email for your receipt, or visit your member area for full details.</p>
  </div>
@endif
...
{/* SCREENSHOT: Customer Data Outside of Orders · members area screen · desktop */}
...
## Order Grouping
{/* SCREENSHOT: Order Grouping · members area screen · desktop */}
...
{/* SCREENSHOT: Related Documentation · members area screen · desktop */}
