...
## Core Concepts
{/* SCREENSHOT: Core Concepts · funnel builder, page events, or published flow · desktop */}
...
## Setup
{/* SCREENSHOT: Setup · funnel builder, page events, or published flow · desktop */}
...
## Use Cases
{/* SCREENSHOT: Use Cases · funnel builder, page events, or published flow · desktop */}
...
## HTML Reference
{/* SCREENSHOT: HTML Reference · funnel builder, page events, or published flow · desktop */}
...
**Example: dynamic container resolved to a component**
...
## Advanced Tips
{/* SCREENSHOT: Advanced Tips · funnel builder, page events, or published flow · desktop */}
