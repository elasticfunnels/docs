...
{/* SCREENSHOT: Understanding Sequence Nodes · funnel builder, page events, or published flow · desktop */}
...
{/* SCREENSHOT: Basic Sequence Usage · funnel builder, page events, or published flow · desktop */}
...
{/* SCREENSHOT: Advanced Sequence Patterns · funnel builder, page events, or published flow · desktop */}
...
{/* SCREENSHOT: Common Sequence Patterns · funnel builder, page events, or published flow · desktop */}
...
## Advanced Usage
{/* SCREENSHOT: Advanced Usage · funnel builder, page events, or published flow · desktop */}
...
## Real-World Examples
{/* SCREENSHOT: Real-World Examples · funnel builder, page events, or published flow · desktop */}
