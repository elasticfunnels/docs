...
## How it works
{/* SCREENSHOT: How it works · funnel builder, page events, or published flow · desktop */}
...
{/* SCREENSHOT: When to use trigger rules · funnel builder, page events, or published flow · desktop */}
...
{/* SCREENSHOT: Setting up trigger rules · funnel builder, page events, or published flow · desktop */}
...
{/* SCREENSHOT: Default vs rule-based · funnel builder, page events, or published flow · desktop */}
...
## Tips
{/* SCREENSHOT: Tips · funnel builder, page events, or published flow · desktop */}
