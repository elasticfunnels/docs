...
{/* SCREENSHOT: Why trigger pages matter · funnel builder, page events, or published flow · desktop */}
...
## Where to set them
{/* SCREENSHOT: Where to set them · funnel builder, page events, or published flow · desktop */}
...
{/* SCREENSHOT: How they relate to the funnel builder · funnel builder, page events, or published flow · desktop */}
