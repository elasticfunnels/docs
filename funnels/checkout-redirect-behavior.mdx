...
{/* SCREENSHOT: Default Redirect Behavior · funnel builder, page events, or published flow · desktop */}
...
3. **Missing Funnel Parameter**: The customer accessed the page without the `?f=funnel_code` parameter and no default funnel is set
...
{/* SCREENSHOT: Domain-Funnel Assignment · funnel builder, page events, or published flow · desktop */}
...
- **Funnel Parameter**: The `?f=funnel_code` URL parameter that explicitly specifies which funnel to use

### How to Assign Domains to Funnels

#### Method 1: Through Funnel Settings (Recommended)
1. Go to **Funnels** in your dashboard
2. Find and select the funnel you want to configure
3. Click **Edit Funnel**
4. In the funnel editor, go to the **Domains** section
5. Click **Add Domain**
6. Enter your domain (e.g., `yoursite.com`)
7. Choose assignment type:
   - **Explicit Only**: Requires `?f=funnel_code` parameter
   - **Default for Domain**: Handles all traffic without parameters
8. Check **"Make Default"** if you want this funnel to handle all traffic on this domain
9. Save your configuration

#### Method 2: Through Settings (Alternative)
1. Go to **Settings** → **Domains** section
2. Click **Add Domain** or find an existing domain
3. Configure domain settings and assign to funnels
4. Set default funnel assignments as needed
...
- **Flexible access**: Some domains can require the `?f=funnel_code` parameter while others have the funnel as default
...
{/* SCREENSHOT: The Funnel Parameter System · funnel builder, page events, or published flow · desktop */}
...
To get a properly formatted funnel link with the correct parameter:

1. Go to **Funnels** in your dashboard
2. Find the funnel you want in the list
3. Click **"Generate Tracking Link"** for that funnel
4. This will provide you with the complete URL including the proper `?f=funnel_code` parameter
5. Use this link for your marketing campaigns, affiliate links, or anywhere you need to ensure visitors enter the specific funnel
...
{/* SCREENSHOT: Configuration Examples · funnel builder, page events, or published flow · desktop */}
...
{/* SCREENSHOT: Troubleshooting Common Issues · funnel builder, page events, or published flow · desktop */}
...
3. **Test with parameters**: Try accessing with `?f=your-funnel-code`
4. **Review purchase links**: Ensure buy buttons are on funnel-assigned pages
5. **Use generated links**: Get proper funnel links via "Generate Tracking Link" in the funnel list
...
5. **Use generated links**: Generate proper tracking links to ensure correct funnel codes
...
**Solutions:**
1. **Verify funnel code**: Check that the funnel code in parameter matches exactly
...
5. **Use generated links**: Get the correct funnel code via "Generate Tracking Link"

## Testing Your Configuration
{/* SCREENSHOT: Testing Your Configuration · funnel builder, page events, or published flow · desktop */}
...
1. Visit with funnel parameter: `https://yoursite.com/page?f=your-funnel-code`
2. Complete a test purchase
3. Confirm the specified funnel executes

### Step 3: Test Edge Cases
1. **Invalid funnel code**: `?f=nonexistent-funnel` (should fall back to default)
...
1. **Use descriptive codes**: Make funnel codes clear and memorable
...
5. **Use generated links**: Always use "Generate Tracking Link" to get correct funnel codes
...
<Note>
Set the domain-funnel assignment before you send traffic. The right assignment keeps checkout redirects predictable and makes conversion tracking easier to trust.
</Note>

## Related Documentation
{/* SCREENSHOT: Related Documentation · funnel builder, page events, or published flow · desktop */}
