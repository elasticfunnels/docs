...
## Quick navigation
{/* SCREENSHOT: Quick navigation · funnel builder, page events, or published flow · desktop */}
...
{/* SCREENSHOT: How Page Events Work · funnel builder, page events, or published flow · desktop */}
...
## Server-side nodes
{/* SCREENSHOT: Server-side nodes · funnel builder, page events, or published flow · desktop */}
...
{/* SCREENSHOT: Browser (frontend) nodes · funnel builder, page events, or published flow · desktop */}
...
## Common patterns
{/* SCREENSHOT: Common patterns · funnel builder, page events, or published flow · desktop */}
...
## Related docs
{/* SCREENSHOT: Related docs · funnel builder, page events, or published flow · desktop */}
