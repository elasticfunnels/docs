...
Typical fields include **code**, **title**, **checkout_title**, **price**, **retail_price**, **currency**, **image**, **description**, **classification**, **tax_category** (tax provider code), **tax_exempt**, subscription fields when applicable, downloadable files, and merchandising categories:
