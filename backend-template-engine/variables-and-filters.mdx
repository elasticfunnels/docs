...
description: 'Backend template variables {{ path }} and filters: default, slice, raw, t (translations), upper, lower, truncate, replace, currency, join, and more.'
---
...
## Variables: `{{ path }}`
{/* SCREENSHOT: Variables: `{{ path }}` · code editor or rendered example · desktop */}
...
## Filters
{/* SCREENSHOT: Filters · code editor or rendered example · desktop */}
...
For [brand translations](/pages/internationalization), **`| t`** treats the piped value as a **translation key** string. Resolution matches **`t()`**: brand dictionary for the resolved locale first, then built-in locale strings. Optional **`| t:params`** passes a context variable or safe expression that resolves to a **plain object** for built-in placeholder interpolation (same rules as **`t(key, params)`**).

```html
{{ 'hero.title' | t }}
{{ t('hero.title') }}
{{ 'product.savings_percent' | t:savingsOpts }}
```

Use **`t()`** and **`| t`** in templates for the same resolution order (brand first, then built-in). See [Internationalization (i18n)](/pages/internationalization) for **`locales()`**, **`{{ locale }}`**, and backend **`await t()`**.

---

## Fallback filters
{/* SCREENSHOT: Fallback filters · code editor or rendered example · desktop */}
...
## String filters
{/* SCREENSHOT: String filters · code editor or rendered example · desktop */}
...
## Number filters
{/* SCREENSHOT: Number filters · code editor or rendered example · desktop */}
...
{/* SCREENSHOT: Boolean / conditional filters · code editor or rendered example · desktop */}
...
## Array filters
{/* SCREENSHOT: Array filters · code editor or rendered example · desktop */}
...
## Date filters
{/* SCREENSHOT: Date filters · code editor or rendered example · desktop */}
...
{/* SCREENSHOT: Output / serialization filters · code editor or rendered example · desktop */}
...
{/* SCREENSHOT: Patterns from real templates · code editor or rendered example · desktop */}
...
{/* SCREENSHOT: String concatenation: `+` · code editor or rendered example · desktop */}
...
## Filter reference
{/* SCREENSHOT: Filter reference · code editor or rendered example · desktop */}
...
| `t` | Translation | optional object | `{{ 'hero.title' \| t }}` |
...
- **`| t`** — Pipe a string key for translations; see [Internationalization](/pages/internationalization).

## Purchase Link Functions
{/* SCREENSHOT: Purchase Link Functions · code editor or rendered example · desktop */}
