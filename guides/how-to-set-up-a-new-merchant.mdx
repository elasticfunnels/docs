...
{/* SCREENSHOT: Step 1: Create the merchant · relevant screen or example output · desktop */}
...
{/* SCREENSHOT: Step 2: Assign the merchant to a domain · relevant screen or example output · desktop */}
...
{/* SCREENSHOT: Step 3: Map products to the merchant · relevant screen or example output · desktop */}
...
{/* SCREENSHOT: Step 4: Connect or create your funnel · relevant screen or example output · desktop */}
...
{/* SCREENSHOT: Step 5: Use adaptive purchase links · relevant screen or example output · desktop */}
...
{/* SCREENSHOT: Testing and debugging · relevant screen or example output · desktop */}
...
{/* SCREENSHOT: Related documentation · relevant screen or example output · desktop */}
