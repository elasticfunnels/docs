...
{/* SCREENSHOT: `http.get(url, headers?)` · code editor or rendered example · desktop */}
...
{/* SCREENSHOT: `http.post(url, body, headers?)` · code editor or rendered example · desktop */}
...
## Response object
{/* SCREENSHOT: Response object · code editor or rendered example · desktop */}
...
## Security
{/* SCREENSHOT: Security · code editor or rendered example · desktop */}
...
{/* SCREENSHOT: Example: external auth check · code editor or rendered example · desktop */}
