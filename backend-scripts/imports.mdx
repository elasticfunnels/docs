...
## Quick example
{/* SCREENSHOT: Quick example · code editor or rendered example · desktop */}
...
{/* SCREENSHOT: Import specifier formats · code editor or rendered example · desktop */}
...
## Named imports
{/* SCREENSHOT: Named imports · code editor or rendered example · desktop */}
...
## Default imports
{/* SCREENSHOT: Default imports · code editor or rendered example · desktop */}
...
## Multiple modules
{/* SCREENSHOT: Multiple modules · code editor or rendered example · desktop */}
...
{/* SCREENSHOT: Module pages work on their own · code editor or rendered example · desktop */}
...
{/* SCREENSHOT: Supported export syntax · code editor or rendered example · desktop */}
...
## Limits
{/* SCREENSHOT: Limits · code editor or rendered example · desktop */}
...
## How imports work
{/* SCREENSHOT: How imports work · code editor or rendered example · desktop */}
