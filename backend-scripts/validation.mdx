...
## Types
{/* SCREENSHOT: Types · code editor or rendered example · desktop */}
...
## Modifiers
{/* SCREENSHOT: Modifiers · code editor or rendered example · desktop */}
...
## Type coercion
{/* SCREENSHOT: Type coercion · code editor or rendered example · desktop */}
...
## Custom validators
{/* SCREENSHOT: Custom validators · code editor or rendered example · desktop */}
...
## Full POST example
{/* SCREENSHOT: Full POST example · code editor or rendered example · desktop */}
...
{/* SCREENSHOT: Nested object example · code editor or rendered example · desktop */}
