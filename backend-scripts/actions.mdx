...
## Session
{/* SCREENSHOT: Session · code editor or rendered example · desktop */}
...
## Cookies
{/* SCREENSHOT: Cookies · code editor or rendered example · desktop */}
...
<Note>
Visitor **tags** are cookies too, but do not set them with `cookie.set()` — use [`addTag()` / `hasTag()` / `removeTag()`](/backend-scripts/tags), which write the naming both the funnel nodes and the browser expect.
</Note>

## Redirect
{/* SCREENSHOT: Redirect · code editor or rendered example · desktop */}
...
## Template Variables
{/* SCREENSHOT: Template Variables · code editor or rendered example · desktop */}
...
## Response Headers
{/* SCREENSHOT: Response Headers · code editor or rendered example · desktop */}
...
## Custom Response
{/* SCREENSHOT: Custom Response · code editor or rendered example · desktop */}
...
## Logging and errors
{/* SCREENSHOT: Logging and errors · code editor or rendered example · desktop */}
