...
## How it works
{/* SCREENSHOT: How it works · code editor or rendered example · desktop */}
...
## Execution order
{/* SCREENSHOT: Execution order · code editor or rendered example · desktop */}
...
## Sandboxing & security
{/* SCREENSHOT: Sandboxing & security · code editor or rendered example · desktop */}
...
{/* SCREENSHOT: When a script throws or times out · code editor or rendered example · desktop */}
...
{/* SCREENSHOT: Multiple script blocks · code editor or rendered example · desktop */}
...
{/* SCREENSHOT: Importing shared modules · code editor or rendered example · desktop */}
