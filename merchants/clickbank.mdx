...
## Prerequisites
{/* SCREENSHOT: Prerequisites · merchant setup screen or postback state · desktop */}
...
{/* SCREENSHOT: Step 1: Create ClickBank Merchant · merchant setup screen or postback state · desktop */}
...
{/* SCREENSHOT: Step 2: Configure Domain-Merchant Assignment · merchant setup screen or postback state · desktop */}
...
{/* SCREENSHOT: Step 3: Set Up ClickBank Pitch Flow · merchant setup screen or postback state · desktop */}
...
{/* SCREENSHOT: Step 4: Configure Funnel Integration · merchant setup screen or postback state · desktop */}
...
{/* SCREENSHOT: Advanced Configuration · merchant setup screen or postback state · desktop */}
...
### Subscription Upsells (Upgrade/Cancel)

If you sell recurring products, you can upgrade or cancel a customer's existing subscription mid-funnel using `[UPSELL_UPGRADE=old_sku, new_sku]` and `[UPSELL_CANCEL]` tags. This requires a **Developer API Key** (different from the encryption key) - see [Subscription Upsells](/products/subscription-upsells) for full setup instructions.
...
{/* SCREENSHOT: Security Best Practices · merchant setup screen or postback state · desktop */}
