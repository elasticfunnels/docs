...
<Note>
The Debug Window loads asynchronously. Open it with **Ctrl + Shift + F12** on any ElasticFunnels page, or click **Debugger** in the top bar on any builder or code editor page.
</Note>
