---
title: 'Overview'
description: 'Introduction to the ElasticFunnels frontend template processor: Alpine-like scope, custom tags, and reactive UI.'
---
...
## Quick start
{/* SCREENSHOT: Quick start · code editor or rendered example · desktop */}
...
{/* SCREENSHOT: What the engine provides · code editor or rendered example · desktop */}
...
{/* SCREENSHOT: Builder-friendly bindings · code editor or rendered example · desktop */}
...
{/* SCREENSHOT: Relation to other docs · code editor or rendered example · desktop */}
