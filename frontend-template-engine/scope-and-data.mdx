...
{/* SCREENSHOT: Global scope: `window.efScope` · code editor or rendered example · desktop */}
...
{/* SCREENSHOT: Cart: `cartItems` / `items` · code editor or rendered example · desktop */}
...
## Checkout: `checkout.*`
{/* SCREENSHOT: Checkout: `checkout.*` · code editor or rendered example · desktop */}
...
{/* SCREENSHOT: URL parameters: `query.*` · code editor or rendered example · desktop */}
...
{/* SCREENSHOT: Effective context and `mode` · code editor or rendered example · desktop */}
...
{/* SCREENSHOT: Runtime API: watch and computed · code editor or rendered example · desktop */}
