...
{/* SCREENSHOT: Text and HTML bindings · code editor or rendered example · desktop */}
...
{/* SCREENSHOT: One-way attribute bindings: `ef-href`, `ef-title`, `ef-alt`, `ef-placeholder` · code editor or rendered example · desktop */}
...
{/* SCREENSHOT: Two-way form binding: `ef-value` / `data-ef-value` / `data-template-value` · code editor or rendered example · desktop */}
...
{/* SCREENSHOT: One-way bindings: `:checked`, `:disabled`, `:value` · code editor or rendered example · desktop */}
...
{/* SCREENSHOT: Event handlers: `@click` and others · code editor or rendered example · desktop */}
...
{/* SCREENSHOT: Lifecycle & visibility directives · code editor or rendered example · desktop */}
...
## Reactivity summary
{/* SCREENSHOT: Reactivity summary · code editor or rendered example · desktop */}
