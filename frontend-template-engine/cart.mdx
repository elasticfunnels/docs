...
{/* SCREENSHOT: Scope: `cartItems` / `items` · code editor or rendered example · desktop */}
...
{/* SCREENSHOT: Subscription details (`item.subscription`) · code editor or rendered example · desktop */}
...
{/* SCREENSHOT: Bonus products (`item.bonuses`) · code editor or rendered example · desktop */}
...
{/* SCREENSHOT: Courses (`item.courses`) · code editor or rendered example · desktop */}
...
{/* SCREENSHOT: Quantity and remove (data attributes) · code editor or rendered example · desktop */}
...
{/* SCREENSHOT: Order bumps (on checkout) · code editor or rendered example · desktop */}
