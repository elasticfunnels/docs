...
{/* SCREENSHOT: Price display: when to use `formatPrice` vs as-is · code editor or rendered example · desktop */}
...
{/* SCREENSHOT: `formatPrice(value, currency?, locale?)` / `money` / `formatCurrency` · code editor or rendered example · desktop */}
...
## Cart helpers
{/* SCREENSHOT: Cart helpers · code editor or rendered example · desktop */}
...
## String helpers
{/* SCREENSHOT: String helpers · code editor or rendered example · desktop */}
...
## Custom functions
{/* SCREENSHOT: Custom functions · code editor or rendered example · desktop */}
