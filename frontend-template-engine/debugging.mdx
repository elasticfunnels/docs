...
{/* SCREENSHOT: Debug Window — Templates tab · code editor or rendered example · desktop */}
...
## Console debug flags
{/* SCREENSHOT: Console debug flags · code editor or rendered example · desktop */}
...
## Inspecting scope
{/* SCREENSHOT: Inspecting scope · code editor or rendered example · desktop */}
...
## Verifying updates
{/* SCREENSHOT: Verifying updates · code editor or rendered example · desktop */}
...
## Common issues
{/* SCREENSHOT: Common issues · code editor or rendered example · desktop */}
