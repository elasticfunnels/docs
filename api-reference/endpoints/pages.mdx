...
```json
{
  ...
  "status": "published",
  "html": "<inline-split-test><variant name=\"control\" weight=\"70\"><h1>Original Headline</h1></variant><variant name=\"challenger\" weight=\"30\"><h1>New Headline</h1></variant></inline-split-test>"
}
```
