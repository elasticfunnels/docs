...
## Backend functions
{/* SCREENSHOT: Backend functions · relevant screen or example output · desktop */}
...
## Course list page
{/* SCREENSHOT: Course list page · relevant screen or example output · desktop */}
...
## Course detail page
{/* SCREENSHOT: Course detail page · relevant screen or example output · desktop */}
...
{/* SCREENSHOT: Auth wrapper for course pages · relevant screen or example output · desktop */}
...
{/* SCREENSHOT: Checking access to a specific product · relevant screen or example output · desktop */}
...
{/* SCREENSHOT: Lesson types and content · relevant screen or example output · desktop */}
...
## Progress API
{/* SCREENSHOT: Progress API · relevant screen or example output · desktop */}
