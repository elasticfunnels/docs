...
## How courses work
{/* SCREENSHOT: How courses work · relevant screen or example output · desktop */}
...
## Setting up a course
{/* SCREENSHOT: Setting up a course · relevant screen or example output · desktop */}
...
{/* SCREENSHOT: Enrollment and `is_assigned` · relevant screen or example output · desktop */}
...
## Progress tracking
{/* SCREENSHOT: Progress tracking · relevant screen or example output · desktop */}
...
- `is_completed` — `true` when the course reaches 100%
- `current_unfinished_lesson` — object with module/lesson ids, titles, and resume URL when in progress
- `resume_url` — direct resume link when available
...
{/* SCREENSHOT: Course object structure · relevant screen or example output · desktop */}
...
## Related
{/* SCREENSHOT: Related · relevant screen or example output · desktop */}
