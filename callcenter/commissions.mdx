...
- **Period** — Filter by reporting month
- **Agent** — View a specific agent's commissions
- **Status** — Show only pending, approved, or paid

The page includes a month picker above the table so you can switch payroll periods without editing URL parameters manually.
...
2. Pick the month in the **Period** field
