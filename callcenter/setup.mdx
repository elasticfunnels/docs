...
1. In the sidebar, click **Call Center** → **Setup**.
...
2. Create the teams you want to use in the call center, for example:
   ...
   - Customer Service
   - Retention
3. Return to **Call Center** → **Setup** → **Call Centers** tab.
...
3. Once a user has the role, they appear in **Call Center** → **Setup** → **Agents** tab automatically.
...
1. Open **Call Center** → **Setup** → **Call Centers** tab.
...
- **Call Center** → **Dashboard**: live metrics overview
