...
You will enter credentials under **Call Center** → **Call Centers** → open a center → **Brand Settings** → **Phone Switch** → select Ytel (see [Phone Switches](/callcenter/phone-switches) for the general flow).
