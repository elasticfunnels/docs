...
reCAPTCHA v3 provides spam protection and fraud detection for your forms without interrupting user experience. This guide will walk you through setting up reCAPTCHA keys for your domains.

<Info>
**Important**: reCAPTCHA is **only used in Collection Forms** within ElasticFunnels. This includes lead capture forms, contact forms, newsletter signups, and other collection form types. It is not used for other form types or page elements.
</Info>

## Understanding reCAPTCHA v3
{/* SCREENSHOT: Understanding reCAPTCHA v3 · domain settings or DNS setup screen · desktop */}

### What is reCAPTCHA v3?
- **Score-based verification** - Works invisibly in the background
- **No user interaction** - No "I'm not a robot" checkboxes
- **Better user experience** - Runs in the background without adding a checkbox
...
{/* SCREENSHOT: Creating reCAPTCHA Keys · domain settings or DNS setup screen · desktop */}
...
1. **Enter a Label**: 
   - Use a descriptive name like "ElasticFunnels Domains"
   - This helps you identify the site later

2. **Select reCAPTCHA Type**:
   - Choose **"Score based (v3)"**
   - This is the recommended type for no-checkbox form experience
...
3. **Add Domains**:
   ...
   - **Note**: You can use one reCAPTCHA key for all domains inside ElasticFunnels
...
## Configuring reCAPTCHA in ElasticFunnels
{/* SCREENSHOT: Configuring reCAPTCHA in ElasticFunnels · domain settings or DNS setup screen · desktop */}
...
{/* SCREENSHOT: Important: reCAPTCHA Usage & Cost Considerations · domain settings or DNS setup screen · desktop */}
...
**reCAPTCHA is only used in Collection Forms** within ElasticFunnels. This includes:
- Lead capture forms
- Contact forms
- Newsletter signups
...
{/* SCREENSHOT: Domain Whitelisting Best Practices · domain settings or DNS setup screen · desktop */}
...
- **One key for all domains**: You can use a single reCAPTCHA key for all your ElasticFunnels domains
...
## Troubleshooting
{/* SCREENSHOT: Troubleshooting · domain settings or DNS setup screen · desktop */}
...
{/* SCREENSHOT: Security Best Practices · domain settings or DNS setup screen · desktop */}
...
{/* SCREENSHOT: Advanced Configuration · domain settings or DNS setup screen · desktop */}
...
{/* SCREENSHOT: Integration with Collection Forms · domain settings or DNS setup screen · desktop */}
...
## Cost Management
{/* SCREENSHOT: Cost Management · domain settings or DNS setup screen · desktop */}
...
<Note>
reCAPTCHA v3 provides spam protection for Collection Forms without adding a checkbox. Remember to add both www and non-www versions of your domains, and you can use one key for all your ElasticFunnels domains. For cost-effective usage, place collection forms on dedicated pages rather than in modals that load on every page view.
</Note>
