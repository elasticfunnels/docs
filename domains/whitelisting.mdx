...
description: 'Automatically whitelist all visitors to specific domains for domain-level content rules'
---
...
{/* SCREENSHOT: Understanding Domain-Level Whitelisting · domain settings or DNS setup screen · desktop */}
...
{/* SCREENSHOT: Setting Up Domain-Level Whitelisting · domain settings or DNS setup screen · desktop */}
...
{/* SCREENSHOT: When to Use Domain-Level Whitelisting · domain settings or DNS setup screen · desktop */}
...
{/* SCREENSHOT: Integration with Other Whitelisting Methods · domain settings or DNS setup screen · desktop */}
...
## Best Practices
{/* SCREENSHOT: Best Practices · domain settings or DNS setup screen · desktop */}
...
{/* SCREENSHOT: Migration from Parameter-Based Whitelisting · domain settings or DNS setup screen · desktop */}
...
{/* SCREENSHOT: Compliance Considerations · domain settings or DNS setup screen · desktop */}
...
<Note>
Domain-level whitelisting keeps visitor rules tied to the domain instead of scattered across page events. Use it only for clear compliance or routing needs.
</Note> 