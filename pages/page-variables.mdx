...
## Variable Formats
{/* SCREENSHOT: Variable Formats · page builder, settings panel, or published page · desktop */}
...
## Date Variables
{/* SCREENSHOT: Date Variables · page builder, settings panel, or published page · desktop */}
...
## Customer Variables
{/* SCREENSHOT: Customer Variables · page builder, settings panel, or published page · desktop */}
...
{/* SCREENSHOT: Brand & System Variables · page builder, settings panel, or published page · desktop */}
...
{/* SCREENSHOT: Query Parameter Variables · page builder, settings panel, or published page · desktop */}
...
{/* SCREENSHOT: Request & device context · page builder, settings panel, or published page · desktop */}
...
## Variable Usage Tips
{/* SCREENSHOT: Variable Usage Tips · page builder, settings panel, or published page · desktop */}
