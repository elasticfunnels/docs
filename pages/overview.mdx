...
description: 'Create, edit, test, and publish pages in ElasticFunnels'
---
...
{/* SCREENSHOT: Pages area · sidebar Pages + main list (optional) · desktop */}
...
{/* SCREENSHOT: Page builder or editor · canvas or code view with sidebar · desktop */}
