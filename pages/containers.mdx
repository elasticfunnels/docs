...
**Whitelisted Container** and **Non-Whitelisted Container** display different content based on visitor whitelisting status, commonly used for ad compliance.

[View Visitor-Based Content Documentation →](/pages/visitor-based-content)
...
- [Visitor-Based Content](/pages/visitor-based-content) - Whitelisting containers
