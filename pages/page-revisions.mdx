...
{/* SCREENSHOT: Viewing Your Revision History · page builder, settings panel, or published page · desktop */}
...
{/* SCREENSHOT: Restoring a Previous Version · page builder, settings panel, or published page · desktop */}
...
## What Gets Saved
{/* SCREENSHOT: What Gets Saved · page builder, settings panel, or published page · desktop */}
...
{/* SCREENSHOT: Discarding Your Draft · page builder, settings panel, or published page · desktop */}
...
{/* SCREENSHOT: Tips for Working with Revisions · page builder, settings panel, or published page · desktop */}
...
## Related
{/* SCREENSHOT: Related · page builder, settings panel, or published page · desktop */}
...
<CardGroup cols={2}>
  ...
  <Card title="Pages Overview" icon="file" href="/pages/overview">
    Create, edit, test, and publish pages
  </Card>
</CardGroup>
