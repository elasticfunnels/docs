...
Use the Interactions Panel to add clicks, hovers, animations, form actions, and custom JavaScript to page elements.
...
## Quick Start
{/* SCREENSHOT: Quick Start · page builder, settings panel, or published page · desktop */}
...
{/* SCREENSHOT: Device-Specific Behavior · page builder, settings panel, or published page · desktop */}
...
- **No Page Reload**: Device changes update without refreshing the page
...
## Available Triggers
{/* SCREENSHOT: Available Triggers · page builder, settings panel, or published page · desktop */}
...
## Available Actions
{/* SCREENSHOT: Available Actions · page builder, settings panel, or published page · desktop */}
...
{/* SCREENSHOT: Configuration Options · page builder, settings panel, or published page · desktop */}
...
{/* SCREENSHOT: Device-Specific Examples · page builder, settings panel, or published page · desktop */}
...
## Advanced Use Cases
{/* SCREENSHOT: Advanced Use Cases · page builder, settings panel, or published page · desktop */}
...
{/* SCREENSHOT: Security Considerations · page builder, settings panel, or published page · desktop */}
